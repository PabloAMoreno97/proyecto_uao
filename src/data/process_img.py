...
def process_image(filepath):
    ...
    try:
        ...
        with open("historial.csv", "a", newline="") as csvfile:
            ...
            # En un entorno de línea de comandos, no hay ID de paciente,
            # así que se usa "N/A"
        ...
        print(("Error: El archivo no fue encontrado"
               f"en la ruta especificada: {filepath}"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=("Herramienta para la detección de "
                     "neumonía desde la línea de comandos."))
    parser.add_argument("filepath",
                        type=str,
                        help=("La ruta completa al archivo "
                              "de imagen DICOM, JPG o PNG."))
    ...
    if label:
        ...
        print(("El proceso de predicción ha fallado. "
